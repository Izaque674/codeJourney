...
async function main() {
    await prisma_1.prisma.tentativa.deleteMany();
    await prisma_1.prisma.casoTeste.deleteMany();
    await prisma_1.prisma.desafio.deleteMany();
    // INICIANTE
    await prisma_1.prisma.desafio.create({
        data: {
